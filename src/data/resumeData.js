...
export const resumeData = {
            ...
            projects: [
                {
                    ...
                    responsibility: "负责美团住宿册营销触达项目和Cross项目Android侧主R。",
                    tags: ["Android", "Java", "Webpack"]
                },
                {
                    name: "视频化能力建设",
                ...
                {
                    name: "团购、周边游、用户评价相关项目",
                    description: "",
                    challenges: "业务技术债务严重，经常需要进行项目重构。业务迭代复杂，历史文档沉淀不全，需要重新梳理业务流程和历史逻辑并沉淀文档。",
                    highlights: "每新熟悉一个模块，都会补充历史代码中的注释，沉淀业务逻辑文档，并定期分享，便于后续开发同学运维，业务性能指标有优化。",
                    responsibility: "主R团购、周边游、用户评价相关项目，承担核心交易页面poi详情页、填单页和二级页面的开发工作。",
                    tags: ["业务开发", "项目重构", "文档沉淀"]
                }
            ]
        }
    ...
    projects: [
        {
            ...
            highlights: "1、架构设计，代码规范定手册拟定，包括前后端；2、利用redis的zset实现LRU队列，多模块共用；3、可视化、数据查询的优化，ireport + jasper 动态报表（pdf, excel）满足客户各类查询需求；4、配置死信队列并通知，保证分布式数据最终一致性；",
    ...
    // 个人简介
    selfIntro: [
        "积极开朗，热爱运动。喜欢篮球、台球、狼人杀、书法、国画、音乐趴。ESTP人格。",
